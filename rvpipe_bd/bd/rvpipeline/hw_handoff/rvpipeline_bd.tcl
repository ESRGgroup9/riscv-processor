...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Net [get_bd_pins imem_0/rd] [get_bd_pins ledController_0/instr] [get_bd_pins riscvpipeline_0/InstrF]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins dmem_0/clk] [get_bd_pins ledController_0/clk] [get_bd_pins riscvpipeline_0/clk]
  ...
  connect_bd_net -net riscvpipeline_0_PCF [get_bd_pins imem_0/a] [get_bd_pins riscvpipeline_0/PCF]
