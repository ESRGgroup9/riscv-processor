...
// Instantiation of Axi Bus Interface M00_AXI
	...
	riscvpipeline_0 pipelinerv (
      ...
      .PCF(PC),                // output wire [31 : 0] PCF
      .InstrF(InstrF),          // input wire [31 : 0] InstrF
      .InstrM(instr),          // output wire [1 : 0] InstrM
      .MemWriteM(MemWrite),    // output wire MemWriteM
      .ALUResultM(AluResult),  // output wire [31 : 0] ALUResultM
      .WriteDataM(WriteData),  // output wire [31 : 0] WriteDataM
...
//    assign axi_awaddr_r = `AXI_GPIO_SLV_ADDR;
//    assign axi_wdata_r = 31'b1;
