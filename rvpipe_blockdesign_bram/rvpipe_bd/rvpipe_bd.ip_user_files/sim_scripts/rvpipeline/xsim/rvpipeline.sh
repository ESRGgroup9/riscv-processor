...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot rvpipeline xil_defaultlib.rvpipeline xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim rvpipeline -key {Behavioral:sim_1:Functional:rvpipeline} -tclbatch cmd.tcl -protoinst "protoinst_files/rvpipeline.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb rvpipeline.wdb xsim.dir)
