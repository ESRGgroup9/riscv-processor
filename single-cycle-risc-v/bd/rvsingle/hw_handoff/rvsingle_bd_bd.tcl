...
################################################################
# This is a generated script based on design: rvsingle_bd
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: riscvsingle_0, and set properties
  set riscvsingle_0 [ create_bd_cell -type ip -vlnv user.org:user:riscvsingle:1.0 riscvsingle_0 ]
  ...
  connect_bd_net -net riscvsingle_0_WriteData [get_bd_pins dmem_0/wd] [get_bd_pins ledController_0/WriteData] [get_bd_pins riscvsingle_0/WriteData]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins dmem_0/be] [get_bd_pins xlslice_0/Dout]
