...
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { led4 }]; #IO_L3N_T0_DQS_AD1N_35 Sch=led[3]
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { led3 }]; #IO_0_35 Sch=led[2]
